---
name: Bug report
about: Something does not work the way the README says it should
title: ''
labels: bug
assignees: ''
---
...
- Notification mode: `local` / `vps`
- macOS version:
- `python3 --version` on the Mac:
- `python3 --version` on the VPS (if using `vps` mode):
- CodexBar version:
